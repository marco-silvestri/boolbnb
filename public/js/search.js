...
$(document).ready(function () {
  ...
  var dataSource = data; //numero minimo stanze

  input.change(function () {
    cleanAll(context);

    for (i = 0; i < data.length; i++) {
      printCard(data, template, context, i);
    }
  });
});
...
module.exports = __webpack_require__(/*! /home/msilvestri/Desktop/Code/boolbnb-team5/resources/js/search.js */"./resources/js/search.js");
